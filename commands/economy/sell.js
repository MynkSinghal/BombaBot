    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'nikes') {
            let embed1 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<:bombacross:764545831285817374> You don't have any Nikes to sell`);
            ...
            let embed2 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<:checkedbomba:777869968121135124> Sold Fresh Nikes For 600 Dollar <:checkdollarbomba:777868122685833287>`);
            ...
            let embed3 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<:bombacross:764545831285817374> You don't have a Car to sell`);
            ...
            let embed4= new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<:checkedbomba:777869968121135124> Sold a Car For 800 Dollar <:checkdollarbomba:777868122685833287>`);
            ...
            let sembed2 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<:bombacross:764545831285817374> You don't have a Mansion to sell`);
            ...
            let sembed3 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<:checkedbomba:777869968121135124> Sold a Mansion For 1200 Dollar <:checkdollarbomba:777868122685833287>`);
            ...
            if (message.content.toLowerCase() === `${prefix}sell`) {
                let embed9 = new MessageEmbed()
                    .setColor("RANDOM")
                    .setDescription(`<:bombacross:764545831285817374> Enter an item to sell. Type ${prefix}store to see list of items`)
