...
module.exports = {
  ...
  async run(client, message, args) {
    ...
    banMember
      ...
      .then(() =>
        message.guild.members.unban(banMember.id).catch(err => console.log(err))
      );
    ...
    message.channel.send({
      embed: {
        color: "#10de47",
        description: `<a:tick:724636137653534720> ${banMember.user.username} has successfully been soft banned from the server.`
      }
    });
  }
};
